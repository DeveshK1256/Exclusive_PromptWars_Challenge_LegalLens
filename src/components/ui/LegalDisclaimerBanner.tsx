...
export const LegalDisclaimerBanner: React.FC = () => {
  return (
    <div className="bg-amber-50 border-b border-amber-200 px-4 py-2 text-xs sm:text-sm text-amber-900 flex items-center justify-center gap-2 text-center" role="region" aria-label="Legal Disclaimer and Product Safety Boundaries">
