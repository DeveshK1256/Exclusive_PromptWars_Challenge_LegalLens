  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="border-b border-slate-800 pb-5 space-y-2">
        ...
        <h1 className="text-3xl font-extrabold text-slate-100">LegalLens AI — Privacy &amp; Data Security Policy</h1>
      ...
      <div className="space-y-6 text-slate-300 text-sm leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 space-y-2">
            ...
            <h3 className="font-bold text-slate-100">Zero Public Model Training</h3>
          ...
          <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 space-y-2">
            ...
            <h3 className="font-bold text-slate-100">Strict User Isolation &amp; RLS</h3>
            <p className="text-xs text-slate-400">
