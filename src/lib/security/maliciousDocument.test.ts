...
Paragraph 2: Employee agrees not to compete for 1 year following termination.`;
    ...
    const impactResult = await runPersonalImpactAgent({
      ...
      findings: [
        {
          id: 'fnd_ca_1',
          document_version_id: 'ver_ca_v1',
          clause_id: 'cls_ca_1',
          severity_level: 'attention',
          finding_kind: 'action_required',
          category: 'Non-Compete Scope',
          summary: '1-year non-compete clause in San Francisco',
          fact: 'Employee agrees not to compete for 1 year following termination.',
          ai_interpretation: 'Restricts working for competitors after leaving.',
          recommendation: 'Seek legal clarification on geographic scope.',
