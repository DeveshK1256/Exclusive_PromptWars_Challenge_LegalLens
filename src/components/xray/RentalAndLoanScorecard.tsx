        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Extracted critical payment windows and notice deadlines for {documentTitle}</p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 text-[11px] font-semibold bg-slate-800 hover:bg-slate-700 text-slate-200 px-3 py-1.5 rounded-lg border border-slate-700 transition-colors"
                >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5 shadow-sm">
        <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Estimate potential late fees, interest charges, and default triggers</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-4 md:col-span-2">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="rent-input" className="block text-xs font-semibold text-slate-300 mb-1">Monthly Payment ($)</label>
                <input
                  id="rent-input"
                  type="number"
                  value={rentAmount}
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2 text-xs text-slate-100 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                />
              </div>
              <div>
                <label htmlFor="days-late-input" className="block text-xs font-semibold text-slate-300 mb-1">Days Past Due</label>
                <input
                  id="days-late-input"
                  type="number"
                  min="0"
            ...
            <div className="p-3.5 bg-slate-950 rounded-xl border border-slate-800 space-y-1.5 text-xs text-slate-300">
              <span className="font-bold text-slate-200 block">Default Trigger Conditions:</span>
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 flex flex-col justify-between space-y-3">
            <div className="space-y-2">
              <span className="text-[10px] font-mono text-slate-400 uppercase tracking-wider block">Estimated Penalty Impact</span>
              <div className="text-3xl font-black text-rose-400">${totalPenalty}</div>
